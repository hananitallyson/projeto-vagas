<main class="flex flex-col">
    <div class="flex justify-between my-1 border-b-2 border-blue-600">
        <h2 class="text-4xl font-bold m-2"><?=TITLE?></h2>
        <a href="index.php">
    ...
    <form action="" method="post">
        <div class="flex flex-col my-2">
            ...
            <input type="text" class="px-2 py-1 border-2 border-grey-600 rounded-lg" name="titulo" value="<?=$vaga->titulo?>">
        </div>

        <div class="flex flex-col my-2">
            <label class="font-bold" for="descricao">Descrição</label>
            <textarea class="px-2 py-1 border-2 border-grey-600 rounded-lg" name="descricao"><?=$vaga->descricao?></textarea>
        </div>
